...
# O coeficiente de assimetria é o que permite dizer se uma determinada 
# distribuição é assimétrica ou não.

# Exemplo: Os seguintes dados representam o número de acidentes diários em um
# complexo industrial durante o período de 50 dias. 
